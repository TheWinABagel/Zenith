...
import safro.apotheosis.api.json.SerializerBuilder;
import safro.apotheosis.ench.EnchModule;
import safro.apotheosis.ench.objects.IEnchantingBlock;
...
public class EnchantingStatManager extends ApothJsonReloadListener<EnchantingStatManager.BlockStats> {
     ...
     * This can be provided by a stat file, or {@link BlockState}
