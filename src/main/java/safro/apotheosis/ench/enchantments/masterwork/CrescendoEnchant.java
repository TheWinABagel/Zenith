...
import safro.apotheosis.mixin.CrossbowItemMixin;
...
public class CrescendoEnchant extends Enchantment {
	...
	public static void onArrowFired(ItemStack crossbow) {
		...
		int level = EnchantmentHelper.getItemEnchantmentLevel(EnchModule.CRESCENDO, crossbow);
	 ...
	 * This is required to retain the ammunition's nbt data, as it is thrown away before {@link }.
	 * Injected by {@link CrossbowItemMixin}
	 */
