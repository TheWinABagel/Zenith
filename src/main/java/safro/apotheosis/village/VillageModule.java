...
import safro.apotheosis.village.fletching.effects.BleedingEffect;
import safro.apotheosis.village.wanderer.WandererReplacements;
import safro.apotheosis.village.wanderer.WandererTradeManager;

import java.io.File;

public class VillageModule {
    public static final RecipeType<FletchingRecipe> FLETCHING = ApotheosisUtil.makeRecipeType(Apotheosis.MODID + ":fletching");
    ...
    // Menus
    public static final MenuType<FletchingContainer> FLETCHING_MENU = ScreenHandlerRegistry.registerSimple(new ResourceLocation(Apotheosis.MODID, "fletching"), FletchingContainer::new);
    ...
    private static MobEffect register(String name, MobEffect effect) {
        return Registry.register(Registry.MOB_EFFECT, new ResourceLocation(Apotheosis.MODID, name), effect);
    }
    ...
    private static <T extends Entity> EntityType<T> register(String name, EntityType<T> type) {
        return Registry.register(Registry.ENTITY_TYPE, new ResourceLocation(Apotheosis.MODID, name), type);
    }
