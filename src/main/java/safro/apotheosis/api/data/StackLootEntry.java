...
import safro.apotheosis.api.json.ItemAdapter;
...
public class StackLootEntry extends LootPoolSingletonContainer {
    ...
    public static final LootPoolEntryType STACKLOOTENTRYTYPE = Registry.register(Registry.LOOT_POOL_ENTRY_TYPE, new ResourceLocation(Apotheosis.MODID, "stack_entry"), new LootPoolEntryType(SERIALIZER));
