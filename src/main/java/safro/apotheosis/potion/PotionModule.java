...
import safro.apotheosis.potion.potions.KnowledgeEffect;
import safro.apotheosis.potion.potions.SunderingEffect;
...
public class PotionModule {
    ...
    private static Potion register(String name, Potion potion) {
        return Registry.register(Registry.POTION, new ResourceLocation(Apotheosis.MODID, name), potion);
    }
}
