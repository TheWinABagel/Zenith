...
public class RainbowColor extends TextColor {
    ...
    public RainbowColor(int[] gradient, String id) {
        super(gradient[0], id);
        this.gradient = gradient;
    }
    public static final RainbowColor RAINBOW = new RainbowColor(colors, "rainbow");

    @Override
    public int getValue() {
        return colors[(int) ((ClientEvents.getTicks() + Minecraft.getInstance().getDeltaFrameTime()) / 0.5F % 255)];
    }
}
