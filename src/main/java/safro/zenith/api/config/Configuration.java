package safro.zenith.api.config;

import static safro.zenith.api.config.Property.Type.BOOLEAN;
import static safro.zenith.api.config.Property.Type.DOUBLE;
import static safro.zenith.api.config.Property.Type.INTEGER;
import static safro.zenith.api.config.Property.Type.STRING;
...
public class Configuration {
    ...
    public Configuration(File file) {
        ...
        try {
            ...
            Zenith.LOGGER.error("An exception occurred while loading config file {}. This file will be renamed to {} " + "and a new config file will be generated.", file.getName(), fileBak.getName(), e);
