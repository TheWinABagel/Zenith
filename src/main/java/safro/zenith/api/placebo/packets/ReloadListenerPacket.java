package safro.zenith.api.placebo.packets;
...
import safro.zenith.api.placebo.network.MessageProvider;
...
public abstract class ReloadListenerPacket<T extends ReloadListenerPacket<T>> implements MessageProvider<T> {
	...
	public static class Content<V extends TypeKey<V>> extends ReloadListenerPacket<Content<V>> {
