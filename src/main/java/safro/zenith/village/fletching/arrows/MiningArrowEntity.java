...
public class MiningArrowEntity extends AbstractArrow implements ExtraSpawnDataEntity {
	...
	public MiningArrowEntity(Level world, double x, double y, double z, ItemStack breakerItem, Type type) {
		super(VillageModule.MINING, x, y, z, world);
		this.pickup = AbstractArrow.Pickup.DISALLOWED;
		this.breakerItem = breakerItem;
		this.type = type;
	}
	...
	public void addAdditionalSaveData(CompoundTag compound) {
		...
		breakerItem.save(ret);
		compound.put("breaker_item", ret);
	...
	public static enum Type {
		IRON(new ResourceLocation(Zenith.MODID, "textures/entity/iron_mining_arrow.png")),
		DIAMOND(new ResourceLocation(Zenith.MODID, "textures/entity/diamond_mining_arrow.png"));
