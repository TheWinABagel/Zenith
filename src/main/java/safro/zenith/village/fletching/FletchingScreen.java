package safro.zenith.village.fletching;
...
public class FletchingScreen extends AbstractContainerScreen<FletchingContainer> {
    public static final ResourceLocation TEXTURES = new ResourceLocation(Zenith.MODID, "textures/gui/fletching_table.png");
