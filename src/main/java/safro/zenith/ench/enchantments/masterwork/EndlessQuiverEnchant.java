...
public class EndlessQuiverEnchant extends Enchantment {
	...
	public static boolean isTrulyInfinite(ItemStack stack, ItemStack bow) {
		return EnchantmentHelper.getItemEnchantmentLevel(EnchModule.ENDLESS_QUIVER, bow) > 0 && stack.getItem() instanceof ArrowItem;
	}
}