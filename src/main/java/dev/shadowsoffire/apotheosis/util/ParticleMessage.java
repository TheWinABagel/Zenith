...
/*
    public static class Provider implements MessageProvider<ParticleMessage> {
        ...
        public ParticleMessage read(FriendlyByteBuf buf) {
            ParticleType<?> type = ((ForgeRegistry<ParticleType<?>>) BuiltInRegistries.PARTICLE_TYPE).getValue(buf.readInt());
        ...
        public void write(ParticleMessage msg, FriendlyByteBuf buf) {
            buf.writeInt(((ForgeRegistry<ParticleType<?>>) BuiltInRegistries.PARTICLE_TYPE).getID(msg.type));
